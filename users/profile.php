...
$query=mysqli_query($con,"update users set fullName='$fname',contactNo='$contactno',addharno='$addharno',address='$address',State='$state',district='$district',pincode='$pincode' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Addhar No</label>
 <div class="col-sm-4">
<input type="text" name="addharno" required="required" value="<?php echo htmlentities($row['addharno']);?>" class="form-control">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="district" required="required" value="<?php echo htmlentities($row['district']);?>" class="form-control">
</div>
</div>
