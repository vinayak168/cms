...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,userEmail,password,contactNo,addharno,status) values('$fullname','$email','$password','$contactno','$addharno','$status')");
...
<script>
function userAvailabilityaddhar() {
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availability_addhar.php",
data:'addharno='+$("#addharno").val(),
type: "POST",
success:function(data){
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <br>
					<input type="text" class="form-control" maxlength="12" name="addharno" placeholder="addhar no" id="addharno" onBlur="userAvailabilityaddhar()" required="required" >
